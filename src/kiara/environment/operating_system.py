...
from kiara.environment import BaseRuntimeEnvironment, RuntimeEnvironmentConfig


class OSRuntimeEnvironment(BaseRuntimeEnvironment):
    ...
    def retrieve_environment_data(
        self, config: RuntimeEnvironmentConfig
