...
class ValueSchema(KiaraModel):
    ...
    For more complex container value_types like array, tables, unions etc, value_types can also be configured with values from the ``type_config`` field.
    """
    ...
    #         raise ValueError(
    #             f"Invalid value type '{self.type}', available value_types: {kiara.value_type_names}"
    #         )
