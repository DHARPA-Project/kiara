...
from kiara.defaults import SERIALIZED_VALUE_TYPE_NAME, ANY_TYPE_NAME
from kiara.models.module import ModuleTypeConfigSchema
from kiara.models.values.value import ValueSet, Value
from kiara.models.values.value_schema import ValueSchema
from kiara.value_types.included_core_types.serialization import DeserializationConfig, SerializedValueModel


class SerializeConfig(ModuleTypeConfigSchema):
...
class SerializeValueModule(KiaraModule):
    ...
    def create_outputs_schema(
        ...
        return {
            "serialized_value": {
                "type": SERIALIZED_VALUE_TYPE_NAME,
                "type_config": {
