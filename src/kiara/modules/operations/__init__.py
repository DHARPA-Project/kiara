...
class OperationsMgmt(object):
    ...
    def operations(self) -> Mapping[str, Operation]:
        ...
        for value_type in self._kiara.value_type_classes.values():
            if hasattr(value_type, "retrieve_included_operations"):
        ...
        for op_config in all_op_configs:
            ...
            for op_type, details in op_types.items():
                ...
                operations_by_type.setdefault(op_type, {})[operation.operation_id] = operation

        self._operations = operations
        self._operations_by_type = operations_by_type
        return self._operations
