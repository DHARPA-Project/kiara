...
def upgrade():
    ...
    op.create_index(op.f('ix_data_types_type_config_hash'), 'data_types', ['type_config_hash'], unique=False)
    op.create_index(op.f('ix_data_types_type_name'), 'data_types', ['type_name'], unique=False)
    ...
    op.create_index(op.f('ix_values_data_type_name'), 'values', ['data_type_name'], unique=False)
