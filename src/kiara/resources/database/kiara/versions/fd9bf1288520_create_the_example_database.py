...
Revision ID: fd9bf1288520
Revises: 
Create Date: 2022-03-11 15:51:10.229136
...
def upgrade():
    ...
    op.create_index(op.f('ix_manifests_manifest_hash'), 'manifests', ['manifest_hash'], unique=False)
    op.create_index(op.f('ix_manifests_module_type'), 'manifests', ['module_type'], unique=False)
    op.create_table('metadata_schema_lookup',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_metadata_schema_lookup_metadata_schema_hash'), 'metadata_schema_lookup', ['metadata_schema_hash'], unique=False)
    ...
    op.create_index(op.f('ix_value_types_type_config_hash'), 'value_types', ['type_config_hash'], unique=False)
    op.create_index(op.f('ix_value_types_type_name'), 'value_types', ['type_name'], unique=False)
    op.create_table('environments',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('metadata_hash', sa.Integer(), nullable=False),
    sa.Column('metadata_schema_id', sa.Integer(), nullable=False),
    sa.Column('metadata_payload', sa.JSON(), nullable=False),
    sa.ForeignKeyConstraint(['metadata_schema_id'], ['metadata_schema_lookup.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('metadata_hash')
    )
    op.create_index(op.f('ix_environments_metadata_hash'), 'environments', ['metadata_hash'], unique=False)
    ...
    sa.Column('started', sqlalchemy_utc.sqltypes.UtcDateTime(timezone=True), nullable=True),
    ...
    sa.Column('value_type_name', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['value_type'], ['value_types.id'], ),
    sa.ForeignKeyConstraint(['value_type_id'], ['value_types.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('value_hash', 'value_size', 'value_type_id')
    )
    op.create_index(op.f('ix_values_value_hash'), 'values', ['value_hash'], unique=False)
    op.create_index(op.f('ix_values_value_size'), 'values', ['value_size'], unique=False)
    op.create_index(op.f('ix_values_value_type_name'), 'values', ['value_type_name'], unique=False)
    op.create_table('destinies',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('value_environments',
...
def downgrade():
    ...
    op.drop_index(op.f('ix_values_value_type_name'), table_name='values')
    ...
    op.drop_index(op.f('ix_value_types_type_name'), table_name='value_types')
    op.drop_index(op.f('ix_value_types_type_config_hash'), table_name='value_types')
    op.drop_table('value_types')
    op.drop_index(op.f('ix_metadata_schema_lookup_metadata_schema_hash'), table_name='metadata_schema_lookup')
